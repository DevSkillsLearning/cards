...
public class CardsResource {
    ...
    @Operation(
            ...
            description = "REST API to get build information that is deployed into card microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "REST API to get java version that is installed into card microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
